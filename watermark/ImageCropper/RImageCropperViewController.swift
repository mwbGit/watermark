...
class RImageCropperViewController: UIViewController {
    ...
    convenience init(num:Int, originalImage:UIImage, cropFrame:CGRect, limitScaleRatio:CGFloat) {
    ...
    func getSubImage() -> [UIImage] {
        ...
        if num == 4 {
            let smallW = w/2
            let myImageRect1 = CGRect.init(x : x, y : y, width: smallW, height: smallW)
            let subImageRef1 = imageRef.cropping(to: myImageRect1)
            let smallImage1 = UIImage.init(cgImage: subImageRef1!)
            
            let myImageRect2 = CGRect.init(x: x + smallW  , y: y , width: smallW, height: smallW)
            let subImageRef2 = imageRef.cropping(to: myImageRect2)
            let smallImage2 = UIImage.init(cgImage: subImageRef2!)
            
            let myImageRect3 = CGRect.init(x: x  , y: y + smallW , width: smallW, height: smallW)
            let subImageRef3 = imageRef.cropping(to: myImageRect3)
            let smallImage3 = UIImage.init(cgImage: subImageRef3!)
            
            let myImageRect4 = CGRect.init(x: x + smallW  , y: y + smallW, width: smallW, height: smallW)
            let subImageRef4 = imageRef.cropping(to: myImageRect4)
            let smallImage4 = UIImage.init(cgImage: subImageRef4!)
            
            var someInts:[UIImage] = [smallImage1, smallImage2, smallImage3, smallImage4]
            return someInts
        } else {
            let smallW = w/3
            let myImageRect1 = CGRect.init(x: x, y: y, width: smallW, height: smallW)
            ...
            let myImageRect3 = CGRect.init(x: x + smallW + smallW, y: y, width: smallW, height: smallW)
            let subImageRef3 = imageRef.cropping(to: myImageRect3)
            let smallImage3 = UIImage.init(cgImage: subImageRef3!)
            
            let myImageRect4 = CGRect.init(x: x  , y: y + smallW, width: smallW, height: smallW)
            let subImageRef4 = imageRef.cropping(to: myImageRect4)
            let smallImage4 = UIImage.init(cgImage: subImageRef4!)
            
            let myImageRect5 = CGRect.init(x: x + smallW , y: y + smallW, width: smallW, height: smallW)
            let subImageRef5 = imageRef.cropping(to: myImageRect5)
            let smallImage5 = UIImage.init(cgImage: subImageRef5!)
            
            let myImageRect6 = CGRect.init(x: x + smallW + smallW , y: y + smallW, width: smallW, height: smallW)
            let subImageRef6 = imageRef.cropping(to: myImageRect6)
            let smallImage6 = UIImage.init(cgImage: subImageRef6!)
            
            let myImageRect7 = CGRect.init(x: x  , y: y + smallW + smallW, width: smallW, height: smallW)
            let subImageRef7 = imageRef.cropping(to: myImageRect7)
            let smallImage7 = UIImage.init(cgImage: subImageRef7!)
            
            let myImageRect8 = CGRect.init(x: x + smallW  , y: y + smallW + smallW , width: smallW, height: smallW)
            let subImageRef8 = imageRef.cropping(to: myImageRect8)
            let smallImage8 = UIImage.init(cgImage: subImageRef8!)
            
            let myImageRect9 = CGRect.init(x: x + smallW + smallW  , y: y + smallW + smallW, width: smallW, height: smallW)
            let subImageRef9 = imageRef.cropping(to: myImageRect9)
            let smallImage9 = UIImage.init(cgImage: subImageRef9!)
            
            var someInts:[UIImage] = [smallImage1, smallImage2, smallImage3, smallImage4, smallImage5, smallImage6, smallImage7, smallImage8, smallImage9]
            return someInts
        }
    }
